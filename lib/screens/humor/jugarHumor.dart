                                  ...
                                  children: [
                                    Row(
                                      children: [
                                        ...
                                        Container(
                                          height: textSize *
                                              2, // Ajusta la altura de la imagen
                                          child: respuesta.respuesta.texto ==
                                                  "Sí, es una broma."
                                              ? Image.asset(
                                                  'assets/img/humor/si.png', // Imagen para "Sí"
                                                  fit: BoxFit.contain,
                                                )
                                              : respuesta.respuesta.texto ==
                                                      "No, no es una broma."
                                                  ? Image.asset(
                                                      'assets/img/humor/no.png', // Imagen para "No"
                                                      fit: BoxFit.contain,
                                                    )
                                                  : SizedBox
                                                      .shrink(), // No se muestra nada si no coincide
                                        ),
                                      ],
                                    ),
                                    SizedBox(
