...
void insertIroniasInitialDataFacil(Database database) async {
  int nivelFacil = 1;
  ...
  int id_P5 = await insertSituacionIroniaInitialData(database,
      '¡Qué lento va el caracol!', pathIronias + 'caracol.png', nivelFacil);
  ...
  int id_P7 = await insertSituacionIroniaInitialData(
      database, '¡Qué mal día hace!', pathIronias + 'sol.png', nivelFacil);
  ...
  int id_P8 = await insertSituacionIroniaInitialData(database,
      '¡Qué mal día hace!', pathIronias + 'lluvia.png', nivelFacil);
